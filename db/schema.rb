...
ActiveRecord::Schema[7.1].define(version: 2024_02_08_192518) do
  ...
  create_table "tags", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "gosips_id"
    t.index ["gosips_id"], name: "index_tags_on_gosips_id"
  end
  ...
  add_foreign_key "gosips", "users"
  add_foreign_key "tags", "gosips", column: "gosips_id"
